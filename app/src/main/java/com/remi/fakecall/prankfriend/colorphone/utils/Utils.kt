...
import com.remi.fakecall.prankfriend.colorphone.helpers.LINK_APP
import com.remi.fakecall.prankfriend.colorphone.helpers.SENSOR_SENSITIVITY
import java.io.*
...
object Utils {
    ...
    fun createBackground(colorArr: IntArray, border: Int, stroke: Int, colorStroke: Int): GradientDrawable {
