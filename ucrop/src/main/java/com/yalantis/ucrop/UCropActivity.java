...
public class UCropActivity extends AppCompatActivity {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        if (mWrapperStateAspectRatio != null) {
            if (aspectRatioX == 0 && aspectRatioY == 0) mWrapperStateAspectRatio.setVisibility(View.VISIBLE);
            else mWrapperStateAspectRatio.setVisibility(View.GONE);
        }
        ...
        if (aspectRatioX >= 0 && aspectRatioY >= 0) {
            ...
            mGestureCropImageView.setTargetAspectRatio(Float.isNaN(targetAspectRatio) ? CropImageView.SOURCE_IMAGE_ASPECT_RATIO : targetAspectRatio);
        } else mGestureCropImageView.setTargetAspectRatio(CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mActiveControlsWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE, Color.parseColor("#242424"));
    ...
    private void setupAppBar() {
        ...
        findViewById(R.id.ivTick).setOnClickListener(v -> {
            vLoading.setVisibility(View.VISIBLE);
            cropAndSaveImage();
            UCrop.setOutput(false);
        });

        findViewById(R.id.ivBack).setOnClickListener(v -> {
            UCrop.setOutput(true);
            finish();
        });
...
//        }
    ...
    private void initiateRootViews() {
        ...
        vLoading.setRepeatCount(LottieDrawable.INFINITE);
        vLoading.setAnimation(R.raw.iv_loading);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        findViewById(R.id.ivOriginal).setOnClickListener(v -> {
            if (vLoading.getVisibility() == View.VISIBLE) return;
            mGestureCropImageView.setTargetAspectRatio(CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
            setStateTickSize(0);
        });
        findViewById(R.id.iv1_1).setOnClickListener(v -> {
            if (vLoading.getVisibility() == View.VISIBLE) return;
            mGestureCropImageView.setTargetAspectRatio(1F);
            setStateTickSize(1);
        });
        findViewById(R.id.iv3_4).setOnClickListener(v -> {
            if (vLoading.getVisibility() == View.VISIBLE) return;
            mGestureCropImageView.setTargetAspectRatio(3 / 4f);
            setStateTickSize(2);
        });
        findViewById(R.id.iv4_3).setOnClickListener(v -> {
            if (vLoading.getVisibility() == View.VISIBLE) return;
            mGestureCropImageView.setTargetAspectRatio(4 / 3f);
            setStateTickSize(3);
        });
        findViewById(R.id.iv9_16).setOnClickListener(v -> {
            if (vLoading.getVisibility() == View.VISIBLE) return;
            mGestureCropImageView.setTargetAspectRatio(9 / 16f);
            setStateTickSize(4);
        });
...
//        }
    ...
    private void setStateTickSize(int pos){
        switch (pos) {
            case 0:
                findViewById(R.id.ivTickOriginal).setVisibility(View.VISIBLE);
                findViewById(R.id.ivTick1_1).setVisibility(View.GONE);
                findViewById(R.id.ivTick3_4).setVisibility(View.GONE);
                findViewById(R.id.ivTick4_3).setVisibility(View.GONE);
                findViewById(R.id.ivTick9_16).setVisibility(View.GONE);
                break;
            case 1:
                findViewById(R.id.ivTickOriginal).setVisibility(View.GONE);
                findViewById(R.id.ivTick1_1).setVisibility(View.VISIBLE);
                findViewById(R.id.ivTick3_4).setVisibility(View.GONE);
                findViewById(R.id.ivTick4_3).setVisibility(View.GONE);
                findViewById(R.id.ivTick9_16).setVisibility(View.GONE);
                break;
            case 2:
                findViewById(R.id.ivTickOriginal).setVisibility(View.GONE);
                findViewById(R.id.ivTick1_1).setVisibility(View.GONE);
                findViewById(R.id.ivTick3_4).setVisibility(View.VISIBLE);
                findViewById(R.id.ivTick4_3).setVisibility(View.GONE);
                findViewById(R.id.ivTick9_16).setVisibility(View.GONE);
                break;
            case 3:
                ...
                findViewById(R.id.ivTick1_1).setVisibility(View.GONE);
                findViewById(R.id.ivTick3_4).setVisibility(View.GONE);
                findViewById(R.id.ivTick4_3).setVisibility(View.VISIBLE);
                findViewById(R.id.ivTick9_16).setVisibility(View.GONE);
                break;
            case 4:
                findViewById(R.id.ivTickOriginal).setVisibility(View.GONE);
                ...
                findViewById(R.id.ivTick3_4).setVisibility(View.GONE);
                findViewById(R.id.ivTick4_3).setVisibility(View.GONE);
                findViewById(R.id.ivTick9_16).setVisibility(View.VISIBLE);
                break;
        }
    }

    private void setupRotateWidget() {
        mTextViewRotateAngle = findViewById(R.id.tvRotate);
...
//        });
    ...
    private final View.OnClickListener mStateClickListener = v -> {
        if (!v.isSelected()) setWidgetState(v.getId());
    };
    ...
    private void changeSelectedTab(int stateViewId) {
        ...
        if (stateViewId == R.id.state_scale)
            ((TextView) mWrapperStateScale.findViewById(R.id.text_view_scale)).setTextColor(Color.parseColor("#242424"));
        else ((TextView) mWrapperStateScale.findViewById(R.id.text_view_scale)).setTextColor(Color.parseColor("#D3D3D3"));

        if (stateViewId == R.id.state_aspect_ratio)
            ((TextView) mWrapperStateAspectRatio.findViewById(R.id.text_view_crop)).setTextColor(Color.parseColor("#242424"));
        else ((TextView) mWrapperStateAspectRatio.findViewById(R.id.text_view_crop)).setTextColor(Color.parseColor("#D3D3D3"));

        if (stateViewId == R.id.state_rotate)
            ((TextView) mWrapperStateRotate.findViewById(R.id.text_view_rotate)).setTextColor(Color.parseColor("#242424"));
        else ((TextView) mWrapperStateRotate.findViewById(R.id.text_view_rotate)).setTextColor(Color.parseColor("#D3D3D3"));
